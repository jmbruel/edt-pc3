...
ifdef::env-github[]
See link:pc3-deliverables.plantuml[]
endif::[]
...
- CEA LIST (Marcos Didonet Del Fabro)
- CNRS/CRISTAL (Romain Rouvoy)
- CNRS/IRIT (Sophie Ebersold)
- CNRS/LaBRI (Thomas Degueule)
- DISP (Jannik Laval)
- IGN (Bruno Vallet)
- IMT Atlantique (Sylvain Guérin, Antoine Beugnard, Fabien Dagnat)
- INRIA/IRISA (Arnaud Blouin, Quentin Perez)

Mailing list PC3: 
jannik.laval@univ-lyon2.fr, arnaud.blouin@irisa.fr, sophie.ebersold@irit.fr, thomas.degueule@labri.fr, marcos.didonetdelfabro@cea.fr, sylvain.guerin@imt-atlantique.fr, romain.rouvoy@univ-lille1.fr, bruno.vallet@ign.fr, quentin.perez@irisa.fr, antoine.beugnard@imt-atlantique.fr, fabien.dagnat@imt-atlantique.fr
